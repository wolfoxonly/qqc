...
* QQcoin.conf: contains configuration settings for QQcoind or QQcoin-qt
* QQcoind.pid: stores the process id of QQcoind while running
...
* debug.log: contains debug information and general logging generated by QQcoind or QQcoin-qt
