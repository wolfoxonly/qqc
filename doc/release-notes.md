...
QQcoin Core version *version* is now available from:

  <https://QQcoin.org/bin/QQcoin-core-*version*/>
...
GCC 4.8.x
--------------
The minimum version of GCC required to compile QQcoin Core is now 4.8. No effort will be
