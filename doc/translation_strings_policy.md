...
This document provides guidelines for internationalization of the QQcoin Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `QQcoin_en.ts` remains unchanged.
