QQcoin Core version 0.10.4 is now available from:

  <https://QQcoin.org/bin/QQcoin-core-0.10.4/>
...
- #6953 `43c2789` Split QQcoin-tx into its own package
- #6953 `dfe0d4d` Include QQcoin-tx binary on Debian/Ubuntu
