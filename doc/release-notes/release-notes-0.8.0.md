QQcoin-Qt version 0.8.0 is now available from:
  http://sourceforge.net/projects/QQcoin/files/QQcoin/QQcoin-0.8.0/
...
Mac and Windows binaries are signed with certificates owned by the QQcoin
...
New/changed settings (command-line or QQcoin.conf file)
--------------------------------------------------------
