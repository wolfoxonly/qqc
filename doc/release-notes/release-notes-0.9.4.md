QQcoin Core version 0.9.4 is now available from:

  https://QQcoin.org/bin/0.9.4/
...
this update is incompatible with the QQcoin system and could lead to consensus
forks.

QQcoin Core released binaries from https://QQcoin.org are unaffected,
as are any built with the gitian deterministic build system.

However, if you are running either

- The Ubuntu PPA from https://launchpad.net/~QQcoin/+archive/ubuntu/QQcoin
- A third-party or self-compiled QQcoin Core

upgrade to QQcoin Core 0.9.4, which includes a workaround, **before** updating
OpenSSL.
