QQcoin version 0.5.4 is now available for download at:
http://sourceforge.net/projects/QQcoin/files/QQcoin/QQcoin-0.5.4/
...
http://gitorious.org/QQcoin/QQcoind-stable/archive-tarball/v0.5.4#.tar.gz
...
Fix QQcoin-Qt notifications under Growl 1.3.
Increase required age of QQcoin-Qt's "not up to date" status from 30 to 90 minutes.
...
Remove wxQQcoin properly when installing QQcoin-Qt over it. (Windows)
