QQcoin Core version 0.13.2 is now available from:

  <https://QQcoin.org/bin/QQcoin-core-0.13.2/>
...
- #8908 `4a974b2` Update QQcoin-qt.desktop (s-matthew-english)
...
- #8932 `106da69` Allow QQcoin-tx to create v2 transactions (btcdrak)
