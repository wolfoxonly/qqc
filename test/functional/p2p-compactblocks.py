...
# TestNode: A peer we use to send messages to QQcoind, and store responses.
...
class CompactBlocksTest(QQcoinTestFramework):
    ...
    # This test actually causes QQcoind to (reasonably!) disconnect us, so do this last.
    ...
    # Test that QQcoind requests compact blocks when we announce new blocks
    ...
    def test_incorrect_blocktxn_response(self, node, test_node, version):
        ...
        # Note that it's possible for QQcoind to be smart enough to know we're
    ...
    def test_getblocktxn_handler(self, node, test_node, version):
        # QQcoind will not send blocktxn responses for blocks whose height is
