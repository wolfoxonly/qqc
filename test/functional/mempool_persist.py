...
By default, QQcoind will dump mempool on shutdown and
...
class MempoolPersistTest(QQcoinTestFramework):
    ...
    def run_test(self):
        ...
        self.start_node(1)
        self.start_node(2)
        # Give QQcoind a second to reload the mempool
        time.sleep(1)
        ...
        self.log.debug("Prevent QQcoind from writing mempool.dat to disk. Verify that `savemempool` fails")
