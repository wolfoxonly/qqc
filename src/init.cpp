...
std::string HelpMessage(HelpMessageMode hmm)
{
    ...
    if (hmm == HMM_BITCOIND)
    {
        ...
        "\n" + _("SSL options: (see the QQcoin Wiki for SSL setup instructions)") + "\n" +
...
#define PROCESS_DEP_ENABLE 0x00000001
    ...
    //
    // ppcoin: -mintxfee and -minrelaytxfee options of QQcoin disabled
    ...
    // Make sure only a single QQcoin process is using the data directory.
    ...
    // requested to kill QQcoin-qt during the last operation. If so, exit.
    ...
    GenerateQQcoins(GetBoolArg("-gen", false), pwalletMain);
