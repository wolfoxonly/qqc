...
static const int64 MIN_TX_FEE = 0 *COIN;//zxb改最小转账限制
...
static const int COINBASE_MATURITY_PPC = 1000;
/** Threshold for nLockTime: below this value it is interpreted as block number, otherwise as UNIX timestamp. */
static const int STAKE_TARGET_SPACING = 1 * 60;//改为2分钟了 10 * 60; // 10-minute block spacing 
static const int STAKE_MIN_AGE = 60 * 60 * 24 * 90; // minimum age for coin age<zxb>
...
static const uint256 hashGenesisBlockOfficial("0x000000ec3ead6567a155b1b55b180c22eb16a549f5f6810b55033bada79cabae");
...
#ifdef TESTING
void QQcoinMiner(CWallet *pwallet, bool fProofOfStake, bool fGenerateSingleBlock = false);
#else
...
public:
    ...
    */
    ...
    /** Amount of QQcoins spent by this transaction.
    ...
    /** Amount of QQcoins coming in to this transaction
...
public:
    ...
    /**
     * Duplicate from QQcoinrpc that originaly define this method.
