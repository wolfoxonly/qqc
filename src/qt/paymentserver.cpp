...
const QString BITCOIN_IPC_PREFIX("QQcoin:");
...
{
    // Install global event filter to catch QFileOpenEvents on the mac (sent when you click QQcoin: links)
    ...
    if (!uriServer->listen(name))
        qDebug() << tr("Cannot start QQcoin: click-to-pay handler");
    else
...
{
    // clicking on QQcoin: URLs creates FileOpen events on the Mac:
